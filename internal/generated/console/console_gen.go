...
var Specs = []runtime.CommandSpec{
	...
	},
	{
		...
		Example: "mosoo console apps create-app \\\n  --app-id <value>\n",
		Notes:   []string{"Uses POST /graphql on the console default hostname (/api)."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
	...
	},
	{
		...
		Example: "mosoo console credentials create \\\n  --input-app-id <app-id> \\\n  --input-vendor-id openai \\\n  --input-name \"OpenAI\" \\\n  --input-api-key 'sk-...' \\\n  -o json\n",
		Notes:   []string{"Uses POST /graphql on the console default hostname (/api).", "For preset providers such as openai or anthropic, omit input.models unless Mosoo asks for explicit model configuration.", "Plaintext terminal input is supported through the generated --input-api-key flag. This can be visible in shell history.", "Current Lathe required variable flags must be present; --set and --set-str can supplement body fields but do not replace required flags."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
	...
	},
	{
		...
		Example: "mosoo console credentials test \\\n  --input-app-id <app-id> \\\n  --input-vendor-id openai \\\n  --input-api-key 'sk-...' \\\n  -o json\n",
		Notes:   []string{"Uses POST /graphql on the console default hostname (/api).", "Plaintext terminal input is supported through the generated --input-api-key flag. This can be visible in shell history.", "Current Lathe required variable flags must be present; --set and --set-str can supplement body fields but do not replace required flags."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
